...
export const SKILLS: Record<SkillNames, Skill> = {
  [SkillNames.JS]: {
    ...
    name: "js",
    label: "JavaScript",
    shortDescription: "sprinkling chaos and callbacks since",
    color: "#f0db4f",
  ...
  [SkillNames.TS]: {
    ...
    name: "ts",
    label: "TypeScript",
    shortDescription:"JavaScript’s overachiever with a helmet on 🪖🔒",
    color: "#007acc",
  ...
  [SkillNames.REACT]: {
    ...
    name: "react",
    label: "React",
    shortDescription: "hooks on hooks on hooks—state of constant suspense",
    color: "#61dafb",
  ...
  [SkillNames.FIREBASE]: {
    ...
    name: "firebase",
    label: "Firebase",
    shortDescription: "rapid backend-in-a-box; watch for the vendor vines",
    color: "#ffca28",
  ...
  [SkillNames.AWS]: {
    ...
    name: "aws",
    label: "AWS",
    shortDescription: "cloud buffet—powerful, but don’t lose your plate",
    color: "#ff9900",
  ...
  [SkillNames.VIM]: {
    ...
    name: "vim",
    label: "Vim",
    shortDescription: "modal wizardry; escape key sold separately",
    color: "#e34c26",
  ...
  [SkillNames.VERCEL]: {
    ...
    name: "vercel",
    label: "Vercel",
    shortDescription: "deploy, hydrate, touch grass—the triangle’s got you",
    color: "#6cc24a",
